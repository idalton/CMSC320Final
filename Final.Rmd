...
I thought this would be a good oppurtunity showcase the data science pipeline. Particularly I wanted to show some data scraping and tidying as well to expand the amount of data available for analysis later.
...
gethoneydatav1 <- function(text,year) {
  ...
  for (index in 1:length(start_lines)){
    ...
    table <- table %>% 
      ...
      # need to adjust varaiable values ie mulitlpe by 1000 etc
      # need to rearange columns such that year is next after state
